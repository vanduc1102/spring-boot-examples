package com.wordpress.aduckdev.module.rest.example.configuration;

import com.wordpress.aduckdev.module.rest.example.exception.GithubRestTemplateErrorHandler;
...
public class RestTemplateConfig {
  ...
  @Value(value = "${app.github.client.max-total}")
  private Integer maxTotal;

  @Value(value = "${app.github.client.default-max-per-route}")
  private Integer defaultMaxPerRoute;

  @Value(value = "${app.github.client.connect-timeout}")
  private Integer connectTimeout;

  @Value(value = "${app.github.client.socket-timeout}")
  private Integer socketTimeout;

  @Value(value = "${app.github.client.keep-alive-header}")
  ...
  public RestTemplate gitHubRestTemplate()
    ...
    restTemplate.setErrorHandler(new GithubRestTemplateErrorHandler());
    return restTemplate;
  }
